...
func (c *BaseController) RespDataMsg(code int, msg string) {
...
func (c *BaseController) RespJSONSuccess() {
	c.AllowCross()
...
func (c *BaseController) RespJSONDataWithSumAndTotal(data interface{}, total int64, sum float64, sumProfit float64) {
	c.RespJSON(bean.CODE_Success, map[string]interface{}{
		"data":   data,
		"total":  total,
		"sum":    sum,
